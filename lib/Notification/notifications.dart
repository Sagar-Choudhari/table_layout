...
Future<void> _showLinuxNotificationWithByteDataIcon() async {
  ...
  // );
  final Uint8List iconImage = assetIcon.buffer.asUint8List();
  final image.Image? iconData = image.decodePng(iconImage);

  // final Uint8List iconData = Uint8List.fromList(assetIcon.buffer.asUint8List());
  // final image.Image? iconData = image.decodePng(iconData);
